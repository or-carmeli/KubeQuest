        ...
        questions: [
            {
              ...
              hint: "חשבו על יחידת הריצה הבסיסית שמכילה קונטיינר אחד או יותר.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על מי מבטיח שמספר מסוים של Pods תמיד רץ.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על ההבדל בין בדיקה שמפעילה restart לבדיקה שמסירה מ-traffic.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על מה קובע אם Pod מקבל תעבורה דרך Service.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על ההתנהגות הרגילה של Pods שהם חלק מ-Deployment.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על מה מוסיף לוח זמנים (schedule) מעבר להרצה חד-פעמית.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על מה ה-Scheduler צריך כדי להחליט לאיזה Node לשבץ Pod.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על בידוד לוגי של משאבים בתוך אותו Cluster.",
              answer: 3,
              explanation:
        ...
        questionsEn: [
            {
              ...
              hint: "Think about the smallest deployable unit and what it wraps around containers.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about what ensures a desired number of Pod replicas is always running.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about the difference between a check that triggers restart vs. one that removes from traffic.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about what determines whether a Pod receives traffic through a Service.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about the default behavior for Pods managed by a Deployment.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about what adds a time-based schedule on top of a one-time execution.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about what the Scheduler needs to decide which Node fits a Pod.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about logical isolation of resources within the same Cluster.",
              answer: 3,
              explanation:
        ...
        questions: [
            {
              ...
              hint: "חשבו על איך מחליפים גרסה בלי downtime לתעבורה חיה.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על פקודת kubectl שמחזירה לגרסה קודמת של Deployment.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על עומסים שדורשים שם רשת קבוע ואחסון ייעודי לכל עותק.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על איך מגבילים כמה Pods מותר להוריד בו-זמנית בזמן תחזוקה.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על מה קורה כש-Pod צורך יותר משאבים מהמותר.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על סימון Node כדי לדחות Pods שאין להם אישור מתאים.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על QoS class של כל Pod וסדר הפינוי כש-Node בלחץ.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על קונטיינר זמני שמוזרק ל-Pod קיים ללא restart.",
              answer: 0,
              explanation:
        ...
        questionsEn: [
            {
              ...
              hint: "Think about how Pods are replaced gradually without dropping live traffic.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about the kubectl command that reverts a Deployment to a previous revision.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about workloads that require a stable network name and dedicated storage per replica.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about how to limit how many Pods can be taken down simultaneously during maintenance.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about what happens when a Pod consumes more resources than allowed.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about marking a Node to repel Pods that lack the matching permission.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about each Pod's QoS class and the eviction order under memory pressure.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about a temporary container injected into a running Pod without restart.",
              answer: 1,
              explanation:
        ...
        questions: [
            {
              ...
              hint: "חשבו על עומס שחייב לרוץ בדיוק פעם אחת על כל Node.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על מנגנון שמשנה מספר replicas אוטומטית לפי מטריקת עומס.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על מה קורה כש-Pod חורג מה-memory limit שהוגדר לו.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על איך מפזרים Pods באופן אחיד בין zones או nodes.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "שימו לב להודעת FailedScheduling ומה היא אומרת על resources ב-Nodes.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על סדר ההפעלה של Pods ב-StatefulSet ומה קורה כש-Pod קודם לא Ready.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "שימו לב לפלט ה-rollout status ומה סטטוס ה-readiness probe אומר.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "השוו את ה-labels על ה-Pods ל-selector של ה-Deployment.",
              answer: 2,
              explanation:
        ...
        questionsEn: [
            {
              ...
              hint: "Think about a workload that must run exactly once on every Node.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about a mechanism that automatically adjusts replica count based on a load metric.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about what happens when a Pod exceeds its configured memory limit.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about how Pods are evenly distributed across zones or nodes.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Focus on the FailedScheduling event and what it says about available Node resources.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about StatefulSet Pod startup order and what happens when a predecessor is not Ready.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "Focus on the rollout status output and what the readiness probe status reveals.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Compare the labels on the Pods with the Deployment's selector.",
              answer: 3,
              explanation:
        ...
        questions: [
            {
              ...
              hint: "חשבו על מה נותן כתובת יציבה ל-Pods שה-IP שלהם משתנה.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על איזה סוג Service מקצה IP חיצוני בסביבת ענן.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על Service שנגיש רק מתוך ה-Cluster עצמו.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על המנגנון שמקשר בין Service לקבוצת Pods ספציפית.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על ההבדל בין הפורט שה-Service חושף לפורט שהאפליקציה מאזינה עליו.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על הרכיב שמתרגם שמות שירות לכתובות IP בתוך ה-Cluster.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על ניתוב HTTP/HTTPS מבחוץ לשירותים פנימיים לפי נתיב או hostname.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על הגדרת חוקים שקובעים איזו תעבורה מותרת בין Pods.",
              answer: 3,
              explanation:
        ...
        questionsEn: [
            {
              ...
              hint: "Think about what provides a stable address for Pods whose IPs change.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about which Service type provisions an external IP in a cloud environment.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about a Service that is only reachable from within the Cluster.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about the mechanism that links a Service to a specific group of Pods.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about the difference between the port the Service exposes and the port the app listens on.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about the component that translates service names to IP addresses inside the Cluster.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about routing HTTP/HTTPS traffic from outside to internal services by path or hostname.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about defining rules that control which traffic is allowed between Pods.",
              answer: 3,
              explanation:
        ...
        questions: [
            {
              ...
              hint: "חשבו על מבנה ה-FQDN הסטנדרטי: service.namespace.svc.cluster.local.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על היתרון של ניתוב מרובה שירותים דרך IP חיצוני אחד.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על איזה Kubernetes resource מכיל את המפתח והתעודה.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על איך URL path קובע לאיזה backend מגיעה הבקשה.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על שליטה בתעבורה היוצאת מ-Pod ולא רק הנכנסת.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על שדה host בחוקי ה-Ingress שמפנה דומיינים שונים ל-backends שונים.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על מה externalTrafficPolicy: Local משנה בהשוואה ל-Cluster.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על הפקודה שמראה את רשימת ה-endpoint IPs שה-Service מכיר.",
              answer: 0,
              explanation:
        ...
        questionsEn: [
            {
              ...
              hint: "Think about the standard FQDN format: service.namespace.svc.cluster.local.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about the advantage of routing multiple services through a single external IP.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about which Kubernetes resource holds the certificate and key for TLS.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about how the URL path determines which backend receives the request.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about controlling traffic leaving a Pod, not just incoming traffic.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about the host field in Ingress rules that directs different domains to different backends.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about what externalTrafficPolicy: Local changes compared to Cluster mode.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about the command that shows the endpoint IPs a Service currently knows about.",
              answer: 2,
              explanation:
        ...
        questions: [
            {
              ...
              hint: "חשבו על מדיניות ברירת המחדל כשלא מוגדר שום NetworkPolicy.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על איזה רכיב ברמת ה-CNI צריך לתמוך ב-NetworkPolicy.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על ביצועים כשיש אלפי חוקי ניתוב לעומת hash tables.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "שימו לב לפלט endpoints ומה המשמעות של <none> ברשימה.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על איזה פורט ופרוטוקול CoreDNS משתמש ומה ה-egress policy חוסמת.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "שימו לב ל-503 וחפשו מה הבעיה ב-backend service שה-Ingress מפנה אליו.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "בדקו את כתובת ה-DNS - האם ה-namespace בכתובת תואם למיקום ה-Service.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על egress policy ברירת מחדל שחוסמת תעבורה יוצאת לאינטרנט.",
              answer: 3,
              explanation:
        ...
        questionsEn: [
            {
              ...
              hint: "Think about the default network behavior when no NetworkPolicy exists at all.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about which CNI-level component must support NetworkPolicy enforcement.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about performance when there are thousands of routing rules vs. hash tables.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "Look at the endpoints output and what <none> in the list means.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about which port and protocol CoreDNS uses and what the egress policy blocks.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "Focus on the 503 error and look for what is wrong with the backend service the Ingress points to.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "Check the DNS address - does the namespace in the address match where the Service actually lives.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about a default egress policy that blocks outbound internet traffic.",
              answer: 1,
              explanation:
        ...
        questions: [
            {
              ...
              hint: "חשבו על ארבעת הרכיבים שרצים על ה-master node ומנהלים את ה-Cluster.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על הסוכן שרץ על כל Node ומוודא ש-Pods רצים כמוגדר.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על מסד הנתונים היחיד שמחזיק את כל מצב ה-Cluster.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על הפקודה שמאתחלת control plane על node חדש.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על הפקודה שמקבלת token מה-master ומצרפת worker.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על Pod שמנוהל ישירות ע'י kubelet ולא דרך API server.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "שימו לב ל-NotReady ומה חסר ב-Cluster חדש כדי שהרשת תעבוד.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על הרכיב שמנהל חוקי רשת על כל Node לצורך ניתוב ל-Services.",
              answer: 1,
              explanation:
        ...
        questionsEn: [
            {
              ...
              hint: "Think about the four components that run on the master node and manage the Cluster.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about the agent running on every Node that ensures Pods are running as specified.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about the single database that holds all Cluster state.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about the command that initializes a control plane on a new node.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about the command that takes a token from the master and adds a worker.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about a Pod managed directly by kubelet without going through the API server.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "Notice the NotReady status and think about what a fresh Cluster is missing for networking.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about the component that manages network rules on each Node for Service routing.",
              answer: 2,
              explanation:
        ...
        questions: [
            {
              ...
              hint: "חשבו על איזה רכיב צריך לשדרג קודם לפני ה-Workers.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על הפקודה הספציפית של etcdctl שיוצרת snapshot.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על הנתיב הסטנדרטי שבו kubeadm שומר manifest files.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על מי באמת מנהל את ה-Static Pod ולמה delete דרך kubectl לא מספיק.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על הפקודה שמחליפה בין clusters או namespaces ב-kubeconfig.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על כמה nodes צריך כדי לעמוד בנפילה של node אחד תוך שמירת רוב.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על מה גורם ל-Node להפסיק לדווח heartbeats ל-control plane.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על סדר ההפעלה הנכון של Control Plane components לאחר שחזור etcd.",
              answer: 1,
              explanation:
        ...
        questionsEn: [
            {
              ...
              hint: "Think about which component must be upgraded first before the Workers.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about the specific etcdctl command that creates a snapshot.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about the standard directory path where kubeadm stores manifest files.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about who actually manages the Static Pod and why kubectl delete is not enough.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about the command that switches between clusters or namespaces in kubeconfig.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about how many nodes are needed to survive one node failure while maintaining majority.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about what causes a Node to stop sending heartbeats to the control plane.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about the correct startup order of Control Plane components after an etcd restore.",
              answer: 2,
              explanation:
        ...
        questions: [
            {
              ...
              hint: "חשבו על הסכנות של הרשאות admin ב-ClusterRoleBinding.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על מה certificate expiry גורם לתקשורת בין רכיבי ה-Cluster.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על כמה זמן שעבר ומה kubelet עושה ל-Pods כש-Node מאבד קשר.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "שימו לב להודעת השגיאה: מה revisionHistoryLimit קובע.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "שימו לב לשם ה-image ולפורט ב-readinessProbe ומה לא תואם.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על שני האיומים הגדולים כשה-etcd לא מוצפן ולא מוגבל גישה.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "שימו לב לשגיאה: אי-תאימות גרסאות בין kubelet ל-control plane.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על יתרונות הפרדת etcd למכונות ייעודיות ב-production.",
              answer: 0,
              explanation:
        ...
        questionsEn: [
            {
              ...
              hint: "Think about the risks of admin-level permissions in a ClusterRoleBinding.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about what certificate expiry does to communication between Cluster components.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about the time elapsed and what kubelet does to Pods when a Node loses contact.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "Focus on the error message: what does revisionHistoryLimit control.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Look at the image name and the readinessProbe port - what does not match.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about the two biggest threats when etcd is unencrypted and access is unrestricted.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Focus on the error: version skew between kubelet and the control plane.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about the benefits of separating etcd onto dedicated machines in production.",
              answer: 3,
              explanation:
        ...
        questions: [
            {
              ...
              hint: "חשבו על מה מבדיל Secret מ-ConfigMap מבחינת אחסון והגנה.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על ההבדל בין encoding (base64) ל-encryption אמיתי.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על שתי הדרכים להזריק ConfigMap ל-Pod: כקובץ או כמשתנה סביבה.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על ה-ServiceAccount שנוצר אוטומטית בכל Namespace חדש.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על ארבע המילים שמרכיבות את השם RBAC.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על הגבלת ברירת מחדל למשאבים ברמת הקונטיינר.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על מה מונע הרצת תהליכים כ-root בתוך קונטיינר.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על ההבדל בין כמות מובטחת (guaranteed) לכמות מקסימלית.",
              answer: 0,
              explanation:
        ...
        questionsEn: [
            {
              ...
              hint: "Think about what differentiates a Secret from a ConfigMap in terms of storage and protection.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about the difference between encoding (base64) and actual encryption.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about the two ways to inject a ConfigMap into a Pod: as a file or as an env variable.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about the ServiceAccount that is automatically created in every new Namespace.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about the four words that make up the acronym RBAC.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about enforcing default resource constraints at the container level.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about what prevents processes from running as root inside a container.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about the difference between a guaranteed amount and a maximum cap.",
              answer: 3,
              explanation:
        ...
        questions: [
            {
              ...
              hint: "חשבו על ההבדל בטווח ההרשאות: namespace בודד מול כל ה-Cluster.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על מה מחבר בין Role/ClusterRole לבין משתמש או ServiceAccount.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על זהות שמייצגת Pod כשהוא פונה ל-API server או לשירותים חיצוניים.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על מה restricted policy אוכפת לגבי הרשאות הרצה של קונטיינרים.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על רכיב שבודק ומאשר או דוחה בקשות לפני שהן נשמרות ב-etcd.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על ההבדל בין הגבלה ברמת הקונטיינר לבין סך כולל ברמת Namespace.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על הגבלת system calls שקונטיינר יכול לבצע ברמת הקרנל.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על רכיב שמסנכרן secrets מ-cloud provider לתוך Kubernetes Secrets.",
              answer: 0,
              explanation:
        ...
        questionsEn: [
            {
              ...
              hint: "Think about the difference in permission scope: a single namespace vs. the entire Cluster.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about what connects a Role/ClusterRole to a user or ServiceAccount.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about the identity a Pod uses when calling the API server or external services.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about what a restricted policy enforces regarding container runtime permissions.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about a component that inspects and approves or rejects requests before they reach etcd.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about the difference between per-container limits and aggregate totals per Namespace.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about restricting which system calls a container can make at the kernel level.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about a component that syncs secrets from a cloud provider into Kubernetes Secrets.",
              answer: 1,
              explanation:
        ...
        questions: [
            {
              ...
              hint: "חשבו על הענקת ההרשאות המינימליות הנדרשות לביצוע משימה.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על הגנה על נתונים ב-etcd כשהדיסק במנוחה, לא בזמן תעבורה.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על איך לשמור Secrets מוצפנים ב-Git בצורה בטוחה.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על שלוש רמות חומרה: privileged, baseline, restricted.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על מנוע מדיניות שאוכף כללים מותאמים אישית על Kubernetes resources.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "שימו לב להודעת השגיאה: איזה verb ואיזה resource חסרים ב-RBAC.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "שימו לב לשגיאה: ה-webhook דחה את הבקשה - מה החוק שנפרץ.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "שימו לב לשגיאה: PSA restricted דוחה בגלל הגדרת אבטחה חסרה.",
              answer: 1,
              explanation:
        ...
        questionsEn: [
            {
              ...
              hint: "Think about granting only the minimum permissions needed to perform a task.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about protecting data stored in etcd when the disk is at rest, not during transit.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about how to safely store encrypted Secrets in a Git repository.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about three severity levels: privileged, baseline, restricted.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about a policy engine that enforces custom rules on Kubernetes resources.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Focus on the error message: which verb and resource are missing from the RBAC binding.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Focus on the error: the webhook rejected the request - what rule was violated.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "Focus on the error: PSA restricted rejects due to a missing security setting.",
              answer: 1,
              explanation:
        ...
        questions: [
            {
              ...
              hint: "חשבו על ההבדל בין האחסון הפיזי לבין הבקשה שה-Pod מגיש.",
              options: [
            ...
            },
            {
              ...
              hint: "חשבו על מה RWO אומר לגבי כמה Nodes יכולים לכתוב בו-זמנית.",
              options: [
            ...
            },
            {
              ...
              tags: ["helm-chart"],
              hint: "חשבו על חבילה שמאגדת Kubernetes manifests עם ערכי ברירת מחדל.",
              options: [
            ...
            },
            {
              ...
              hint: "חשבו על הפקודה הסטנדרטית של Helm להתקנה ראשונית.",
              options: [
              "helm upgrade",
              "helm template",
              "helm install",
            ...
            },
            {
              ...
              hint: "חשבו על volume זמני שנוצר ונמחק יחד עם ה-Pod.",
              options: [
            ...
            },
            {
              ...
              hint: "חשבו על מי שמגדיר את סוג הדיסק ואיכות השירות עבור PVs.",
              options: [
            ...
            },
            {
              ...
              hint: "חשבו על מחזור החיים של emptyDir ביחס ל-Pod שמשתמש בו.",
              options: [
            ...
            },
            {
              ...
              hint: "חשבו על הקובץ שמכיל ערכי ברירת מחדל הניתנים לדריסה.",
              options: [
        ...
        questionsEn: [
            {
              ...
              hint: "Think about the difference between the physical storage and the request a Pod makes.",
              options: [
            ...
            },
            {
              ...
              hint: "Think about what RWO means regarding how many Nodes can write simultaneously.",
              options: [
            ...
            },
            {
              ...
              tags: ["helm-chart"],
              hint: "Think about a package that bundles Kubernetes manifests with configurable defaults.",
              options: [
            ...
            },
            {
              ...
              hint: "Think about the standard Helm command for a first-time installation.",
              options: [
              "helm upgrade",
              "helm template",
              "helm install",
            ...
            {
              q: "What is emptyDir?",
              hint: "Think about a temporary volume that is created and deleted along with the Pod.",
              options: [
            ...
            },
            {
              ...
              hint: "Think about what defines the disk type and quality of service for PVs.",
              options: [
            ...
            },
            {
              ...
              hint: "Think about the lifecycle of emptyDir relative to the Pod that uses it.",
              options: [
            ...
            },
            {
              ...
              hint: "Think about the file that holds configurable defaults that can be overridden.",
              options: [
        ...
        questions: [
            {
              ...
              hint: "חשבו על מי יוצר את ה-PV אוטומטית כשה-PVC מבקש אחסון.",
              options: [
            ...
            },
            {
              ...
              hint: "חשבו על מה קורה ל-PV הפיזי כש-PVC נמחק.",
              options: [
            ...
            },
            {
              ...
              hint: "חשבו על הדגל --set בפקודת helm install/upgrade.",
              options: [
            ...
            },
            {
              ...
              hint: "חשבו על איזו הגדרה ב-StorageClass צריכה לאפשר הרחבה.",
              options: [
            ...
            {
              q: "מה הפקודה\n\n```\nhelm template\n```\n\nעושה?",
              hint: "חשבו על ההבדל בין רינדור מקומי של templates לבין התקנה בפועל.",
              options: [
            ...
            {
              q: "מה עושה הפקודה\n\n```\n$ helm rollback\n```",
              hint: "חשבו על חזרה לגרסה קודמת של Helm release שעבדה.",
              options: [
            ...
            },
            {
              ...
              hint: "חשבו על מה מונע מ-PVC למצוא PV מתאים.",
              options: [
            ...
            },
            {
              ...
              hint: "חשבו על התנאים שצריכים להתאים בין PV ל-PVC: גודל, access mode, ו-storageClass.",
              options: [
        ...
        questionsEn: [
            {
              ...
              tags: ["dynamic-provisioning"],
              hint: "Think about who automatically creates the PV when a PVC requests storage.",
              options: [
            ...
            },
            {
              ...
              hint: "Think about what happens to the physical PV when the PVC is deleted.",
              options: [
            ...
            },
            {
              ...
              hint: "Think about the --set flag in helm install/upgrade commands.",
              options: [
              "helm template --set key=value",
              "helm rollback --set key=value",
              "helm install --set key=value",
            ...
            },
            {
              ...
              hint: "Think about which StorageClass setting must be enabled to allow expansion.",
              options: [
            ...
            },
            {
              ...
              hint: "Think about the difference between rendering templates locally vs. actually installing.",
              options: [
            ...
            },
            {
              ...
              hint: "Think about reverting to a previous working version of a Helm release.",
              options: [
            ...
            },
            {
              ...
              hint: "Think about what prevents a PVC from finding a matching PV.",
              options: [
            ...
            },
            {
              ...
              tags: ["storage-binding"],
              hint: "Think about the conditions that must match between PV and PVC: size, access mode, and storageClass.",
              options: [
        ...
        questions: [
            {
              ...
              hint: "חשבו על ממשק סטנדרטי שמאפשר ל-Kubernetes לעבוד עם כל ספק אחסון.",
              options: [
            ...
            },
            {
              ...
              hint: "חשבו על פעולות שרצות לפני או אחרי שלב מסוים ב-Helm lifecycle.",
              options: [
            ...
            },
            {
              ...
              hint: "חשבו על יצירת גיבוי נקודתי של volume ברגע מסוים בזמן.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על volumeClaimTemplates שיוצרים PVC ייעודי לכל replica.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על דחיית הקצאת ה-PV עד שה-Pod באמת מתוזמן ל-Node ספציפי.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "שימו לב להודעת ProvisioningFailed ומה היא אומרת על StorageClass.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על הפקודה שמציגה היסטוריית releases ומאפשרת לבחור גרסה לחזרה.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על מגבלת Availability Zone של EBS volumes ב-AWS.",
              answer: 1,
              explanation:
        ...
        questionsEn: [
            {
              ...
              hint: "Think about a standard interface that lets Kubernetes work with any storage provider.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about actions that run before or after a specific stage in the Helm lifecycle.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about creating a point-in-time backup of a volume at a specific moment.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about volumeClaimTemplates that create a dedicated PVC for each replica.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about delaying PV allocation until the Pod is actually scheduled to a specific Node.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Focus on the ProvisioningFailed event and what it says about the StorageClass.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about the command that shows release history and lets you pick a version to revert to.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about the Availability Zone limitation of EBS volumes in AWS.",
              answer: 3,
              explanation:
        ...
        questions: [
            {
              ...
              hint: "חשבו על הפקודה שמציגה events ומידע מפורט על Pod בבעיה.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על היכן לבדוק קודם כש-Pod רץ אבל האפליקציה שבתוכו מחזירה שגיאות.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על הפקודה שמציגה אירועים ברמת ה-Cluster כמו scheduling, pulling, ו-errors.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על ההבדל בין קונטיינר שרץ טכנית לבין קונטיינר שעובר health checks.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על הדגל שמאפשר לראות לוגים של קונטיינר שכבר סיים לרוץ.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על פקודה שמציגה צריכת CPU וזיכרון בפועל של Nodes.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על endpoint שמחזיר את מצב הבריאות של ה-API server.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על הצגת כל ה-kubeconfig contexts והקשרם ל-clusters שונים.",
              answer: 0,
              explanation:
        ...
        questionsEn: [
            {
              ...
              hint: "Think about the command that shows events and detailed info for a problematic Pod.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about where to look first when the Pod is running but the app inside returns errors.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about the command that shows Cluster-level events like scheduling, pulling, and errors.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about the difference between a container that is technically running and one passing health checks.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about the flag that lets you see logs from a container that has already exited.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about a command that shows actual CPU and memory consumption across Nodes.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about the endpoint that returns the health status of the API server.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about listing all kubeconfig contexts and their association with different clusters.",
              answer: 3,
              explanation:
        ...
        questions: [
            {
              ...
              hint: "חשבו על מה קורה כש-Pod קורס שוב ושוב ו-Kubernetes מגדיל את זמן ההמתנה.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על שתי סיבות נפוצות: שם image שגוי או חוסר גישה ל-registry.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "שימו לב ל-exit code 137 ולהודעת OOMKilled בפלט describe.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "שימו לב להודעת Insufficient cpu ומה היא אומרת על הקיבולת ב-Cluster.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על ההבדל בתגובה: liveness משפיע על restart, readiness על traffic.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על מה מעכב יצירת קונטיינר: volume mount, image pull, או secret חסר.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על מה קורה כש-gracePeriod עובר ו-Pod עדיין לא נסגר.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "שימו לב ל-DiskPressure condition ומה גורם ל-kubelet לפנות Pods.",
              answer: 2,
              explanation:
        ...
        questionsEn: [
            {
              ...
              hint: "Think about what happens when a Pod crashes repeatedly and Kubernetes increases the wait time.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about the two common causes: wrong image name or missing registry credentials.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "Focus on exit code 137 and the OOMKilled reason in the describe output.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Focus on the Insufficient cpu message and what it says about available Cluster capacity.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about the difference: liveness affects restart, readiness affects traffic routing.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about what delays container creation: volume mount, image pull, or a missing secret.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about what happens when the gracePeriod expires and the Pod still has not shut down.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "Focus on the DiskPressure condition and what triggers kubelet to evict Pods.",
              answer: 0,
              explanation:
        ...
        questions: [
            {
              ...
              hint: "חשבו על שתי פעולות מיידיות: בדיקת לוגים של ה-Pod החדש וחזרה לגרסה קודמת.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על שתי הסיבות הנפוצות: kubelet לא רץ או בעיית רשת ל-control plane.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על פקודה שמפנה Pods מ-Node לפני תחזוקה בצורה מבוקרת.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על בדיקת תקינות של CoreDNS pods כצעד ראשון.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על etcdctl snapshot save והנתיבים לתעודות TLS.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "שימו לב לנתיב ולפורט ב-httpGet של ה-liveness probe ובדקו מה לא תואם.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "שימו לב להודעת השגיאה: ה-container עדיין לא עלה - בדקו את הסטטוס.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "חשבו על מה חסר בקלסטר חדש כדי שהרשת בין Pods תעבוד.",
              answer: 3,
              explanation:
        ...
        questionsEn: [
            {
              ...
              hint: "Think about two immediate actions: check new Pod logs and revert to the previous version.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about the two common causes: kubelet not running or network issue to the control plane.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about a command that safely evicts Pods from a Node before maintenance.",
              answer: 2,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about checking CoreDNS pod health as the first diagnostic step.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about etcdctl snapshot save and the paths to TLS certificates.",
              answer: 1,
              explanation:
            ...
            },
            {
              ...
              hint: "Focus on the path and port in the httpGet liveness probe and check what does not match.",
              answer: 3,
              explanation:
            ...
            },
            {
              ...
              hint: "Focus on the error message: the container is not yet running - check the Pod status.",
              answer: 0,
              explanation:
            ...
            },
            {
              ...
              hint: "Think about what a fresh cluster is missing for Pod-to-Pod networking to work.",
              answer: 0,
              explanation:
        ...
        questions: [
          {
            ...
            options: [
              ...
              "ps aux --sort=-%mem | head",
              "free -m"],
            hint: "חשבו על פקודה שממיינת תהליכים לפי צריכת משאב ספציפי.",
            answer: 2,
          ...
          },
          {
            ...
            hint: "שימו לב ל-96% תפוסה ומה הצעד הראשון לזיהוי מה תופס את המקום.",
            answer: 0,
          ...
          },
          {
            ...
            hint: "חשבו על הפקודה שמציגה לוגים של שירות ספציפי ב-systemd.",
            answer: 3,
          ...
          },
          {
            ...
            options: [
              ...
              "top -u nginx",
              "netstat -tlnp"],
            hint: "חשבו על הפקודה שנותנת תמונת מצב מלאה של שירות: סטטוס, PID, ולוגים.",
            answer: 1,
          ...
          },
          {
            ...
            hint: "חשבו על ההבדל בין הצגת תוכן קיים לבין מעקב אחרי שורות חדשות.",
            answer: 2,
          ...
          },
          {
            ...
            hint: "שימו לב למצב D בפלט ומה הוא מעיד על פעולת I/O ברמת הקרנל.",
            answer: 3,
          ...
          },
          {
            ...
            hint: "שימו לב להודעת Connection refused ומה היא מעידה על זמינות הפורט.",
            answer: 1,
          ...
          },
          {
            ...
            hint: "חשבו על מה lsof חושף לגבי תהליכים שמחזיקים קבצים פתוחים.",
            answer: 1,
        ...
        questionsEn: [
          {
            ...
            options: [
              ...
              "ps aux --sort=-%mem | head",
              "free -m"],
            hint: "Think about a command that sorts processes by a specific resource metric.",
            answer: 2,
          ...
          },
          {
            ...
            hint: "Focus on the 96% usage and what the first step is to find what consumes the space.",
            answer: 0,
          ...
          },
          {
            ...
            options: [
              ...
              "dmesg | tail",
              "journalctl -u service-name --no-pager -n 50"],
            hint: "Think about the command that shows logs for a specific systemd-managed service.",
            answer: 3,
          ...
          },
          {
            ...
            options: [
              ...
              "top -u nginx",
              "netstat -tlnp"],
            hint: "Think about the command that gives a full service snapshot: status, PID, and logs.",
            answer: 1,
          ...
          },
          {
            ...
            hint: "Think about the difference between displaying existing content and following new lines.",
            answer: 2,
          ...
          },
          {
            ...
            hint: "Focus on the D state in the output and what it indicates about kernel-level I/O.",
            answer: 3,
          ...
          },
          {
            ...
            hint: "Focus on the Connection refused message and what it reveals about port availability.",
            answer: 1,
          ...
          },
          {
            ...
            hint: "Think about what lsof reveals about processes holding open file handles.",
            answer: 1,
        ...
        questions: [
          {
            ...
            hint: "שימו לב לערך %id בפלט top ומה ערך נמוך שלו מעיד.",
            answer: 1,
          ...
          },
          {
            ...
            hint: "שימו לב לעמודה available בפלט free ולא לעמודה free.",
            answer: 0,
          ...
          },
          {
            ...
            hint: "השוו את ערכי load average למספר הליבות (4) בשרת.",
            answer: 3,
          ...
          },
          {
            ...
            hint: "שימו לב לכתובת 0.0.0.0 ומה היא אומרת על נגישות מבחוץ.",
            answer: 0,
          ...
          },
          {
            ...
            hint: "חשבו על שילוב שני grep: אחד לסינון סוג ואחד לסינון לפי זמן.",
            answer: 1,
          ...
          },
          {
            ...
            hint: "חשבו על מי אחראי לאסוף את ה-exit status של תהליך zombie.",
            answer: 0,
          ...
          },
          {
            ...
            hint: "שימו לב לשילוב של %util ו-await ומה הם מעידים על מצב הדיסק.",
            answer: 3,
          ...
          },
          {
            ...
            hint: "שימו לב להודעת Out of memory בפלט dmesg ומי הרג את התהליך.",
            answer: 2,
        ...
        questionsEn: [
          {
            ...
            hint: "Focus on the %id value in top output and what a low value indicates.",
            answer: 1,
          ...
          },
          {
            ...
            hint: "Focus on the available column in free output, not the free column.",
            answer: 0,
          ...
          },
          {
            ...
            hint: "Compare the load average values against the server's core count (4).",
            answer: 3,
          ...
          },
          {
            ...
            hint: "Focus on the 0.0.0.0 address and what it means for external accessibility.",
            answer: 0,
          ...
          },
          {
            ...
            options: [
              ...
              "`head -1000 log.txt | grep ERROR`",
              "`tail -f log.txt | grep ERROR`"],
            hint: "Think about combining two greps: one to filter by type and one to filter by time.",
            answer: 1,
          ...
          },
          {
            ...
            hint: "Think about who is responsible for collecting the exit status of a zombie process.",
            answer: 0,
          ...
          },
          {
            ...
            hint: "Focus on the combination of %util and await values and what they reveal about disk health.",
            answer: 3,
          ...
          },
          {
            ...
            hint: "Focus on the Out of memory message in dmesg and what mechanism killed the process.",
            answer: 2,
        ...
        questions: [
          {
            ...
            hint: "שימו לב לאחוז הזמן על futex ומה זה מעיד על locks בין threads.",
            answer: 1,
          ...
          },
          {
            ...
            hint: "שימו לב לערכי orphan ו-tw (TIME_WAIT) ומה מספרים גבוהים מעידים.",
            answer: 3,
          ...
          },
          {
            ...
            hint: "שימו לב לאפסים ב-orders הגבוהים ומה זה אומר על בלוקים רציפים.",
            answer: 0,
          ...
          },
          {
            ...
            hint: "השוו את מספר ה-FDs הפתוחים למגבלה ומה קורה כשמגיעים אליה.",
            answer: 2,
          ...
          },
          {
            ...
            hint: "השוו את rxkB/s למגבלת 1Gbps (כ-125MB/s) ושימו לב ל-rxdrop.",
            answer: 0,
          ...
          },
          {
            ...
            hint: "שימו לב לאחוז הגבוה על _raw_spin_lock ומה זה מעיד על תחרות בין cores.",
            answer: 3,
          ...
          },
          {
            ...
            hint: "השוו את מספר החיבורים הפעילים לטווח הפורטים הזמין.",
            answer: 1,
          ...
          },
          {
            ...
            hint: "חשבו על טבלת errno בקרנל ומה הערך -12 מייצג.",
            answer: 0,
        ...
        questionsEn: [
          {
            ...
            hint: "Focus on the percentage of time spent on futex and what it reveals about thread locking.",
            answer: 1,
          ...
          },
          {
            ...
            hint: "Focus on the orphan and tw (TIME_WAIT) values and what high numbers indicate.",
            answer: 3,
          ...
          },
          {
            ...
            hint: "Notice the zeros in higher orders and what that means for contiguous block availability.",
            answer: 0,
          ...
          },
          {
            ...
            hint: "Compare the number of open FDs against the limit and what happens when it is reached.",
            answer: 2,
          ...
          },
          {
            ...
            hint: "Compare rxkB/s against the 1Gbps limit (~125MB/s) and note the rxdrop count.",
            answer: 0,
          ...
          },
          {
            ...
            hint: "Focus on the high percentage on _raw_spin_lock and what it reveals about core contention.",
            answer: 3,
          ...
          },
          {
            ...
            hint: "Compare the number of active connections against the available port range.",
            answer: 1,
          ...
          },
          {
            ...
            hint: "Think about the kernel errno table and what the value -12 represents.",
            answer: 0,
        ...
        questions: [
          {
            ...
            hint: "חשבו על מה OutOfSync מציין ומה הצעד הראשון לבדיקת ההבדלים.",
            answer: 2,
          ...
          },
          {
            ...
            hint: "חשבו על העיקרון המרכזי של GitOps: מאיפה מגיע המצב הרצוי.",
            answer: 1,
          ...
          },
          {
            ...
            hint: "חשבו על מה קורה כש-ArgoCD מזהה שינוי שלא הגיע מ-Git.",
            answer: 0,
          ...
          },
          {
            ...
            hint: "חשבו על ההבדל: Synced עוסק בהתאמה ל-Git, Healthy עוסק במצב הריצה.",
            answer: 0,
          ...
          },
          {
            ...
            hint: "חשבו על העיקרון של GitOps: כל שינוי חייב לעבור דרך Git.",
            answer: 2,
          ...
          },
          {
            ...
            hint: "חשבו על מה targetRevision קובע לגבי איזה branch או tag ArgoCD עוקב אחריו.",
            answer: 0,
          ...
          },
          {
            ...
            hint: "חשבו על ההבדל: Synced אומר שה-manifest תואם, Degraded אומר שה-Pod לא בריא.",
            answer: 1,
          ...
          },
          {
            ...
            hint: "חשבו על מה self-heal עושה כשמזהה שינוי ידני שסוטה מ-Git.",
            answer: 1,
        ...
        questionsEn: [
          {
            ...
            hint: "Think about what OutOfSync indicates and the first step to check the differences.",
            answer: 2,
          ...
          },
          {
            ...
            hint: "Think about the core GitOps principle: where does the desired state come from.",
            answer: 1,
          ...
          },
          {
            ...
            hint: "Think about what happens when ArgoCD detects a change that did not come from Git.",
            answer: 0,
          ...
          },
          {
            ...
            hint: "Think about the distinction: Synced is about matching Git, Healthy is about runtime state.",
            answer: 0,
          ...
          },
          {
            ...
            hint: "Think about the GitOps principle: every change must go through Git.",
            answer: 2,
          ...
          },
          {
            ...
            hint: "Think about what targetRevision determines regarding which branch or tag ArgoCD tracks.",
            answer: 0,
          ...
          },
          {
            ...
            hint: "Think about the difference: Synced means manifests match, Degraded means Pods are unhealthy.",
            answer: 1,
          ...
          },
          {
            ...
            hint: "Think about what self-heal does when it detects a manual change that deviates from Git.",
            answer: 1,
        ...
        questions: [
          {
            ...
            hint: "חשבו על הפקודה שמציגה את ה-diff בין Git למצב הנוכחי.",
            answer: 1,
          ...
          },
          {
            ...
            hint: "חשבו על איך ArgoCD מזהה שינויים ב-Git: polling מול webhook.",
            answer: 2,
          ...
          },
          {
            ...
            hint: "חשבו על רכיב שמנהל sync של מספר אפליקציות בסדר מוגדר.",
            answer: 1,
          ...
          },
          {
            ...
            hint: "חשבו על sync phases: hooks שרצים לפני ואחרי ה-sync עצמו.",
            answer: 1,
          ...
          },
          {
            ...
            hint: "חשבו על ההגדרה שמאפשרת ל-ArgoCD למחוק resources שהוסרו מ-Git.",
            answer: 0,
          ...
          },
          {
            ...
            hint: "חשבו על מה ignoreDifferences מאפשר ל-ArgoCD להתעלם ממנו.",
            answer: 0,
          ...
          },
          {
            ...
            hint: "חשבו על כלי שמנהל ובונה multiple Kubernetes manifests לפני ש-ArgoCD עושה sync.",
            answer: 0,
          ...
          },
          {
            ...
            hint: "חשבו על האסטרטגיה שמחליפה את כל ה-resources בבת אחת לעומת בהדרגה.",
            answer: 1,
        ...
        questionsEn: [
          {
            ...
            hint: "Think about the command that shows the diff between Git and the current live state.",
            answer: 1,
          ...
          },
          {
            ...
            hint: "Think about how ArgoCD detects Git changes: polling interval vs. webhook triggers.",
            answer: 2,
          ...
          },
          {
            ...
            hint: "Think about a resource that manages syncing multiple applications in a defined order.",
            answer: 1,
          ...
          },
          {
            ...
            hint: "Think about sync phases: hooks that run before and after the sync itself.",
            answer: 1,
          ...
          },
          {
            ...
            hint: "Think about the setting that lets ArgoCD delete resources removed from Git.",
            answer: 0,
          ...
          },
          {
            ...
            hint: "Think about what ignoreDifferences allows ArgoCD to skip during comparison.",
            answer: 0,
          ...
          },
          {
            ...
            hint: "Think about a tool that manages and builds multiple Kubernetes manifests before ArgoCD syncs.",
            answer: 0,
          ...
          },
          {
            ...
            hint: "Think about the strategy that replaces all resources at once vs. gradually.",
            answer: 1,
        ...
        questions: [
          {
            ...
            hint: "שימו לב לשגיאה ComparisonError ומה היא אומרת על גישה ל-Git repo.",
            answer: 1,
          ...
          },
          {
            ...
            hint: "חשבו על מה retry ב-sync policy עושה כש-sync נכשל.",
            answer: 1,
          ...
          },
          {
            ...
            hint: "חשבו על מה finalizer ב-ArgoCD מבטיח כשמוחקים Application.",
            answer: 2,
          ...
          },
          {
            ...
            hint: "שימו לב ל-health status Degraded ומה הוא מעיד על Pods שרצים.",
            answer: 0,
          ...
          },
          {
            ...
            hint: "חשבו על ApplicationSet ויצירת Application לכל סביבה מתוך generator.",
            answer: 0,
          ...
          },
          {
            ...
            hint: "שימו לב שה-app Synced אבל ה-Pod מתנהג לא כצפוי - בדקו את ה-values.",
            answer: 0,
          ...
          },
          {
            ...
            hint: "חשבו על חוק sync-wave שקובע את הסדר בין resources.",
            answer: 3,
          ...
          },
          {
            ...
            hint: "שימו לב שה-Application Healthy אבל ה-Service מחזיר 503 - בדקו selector.",
            answer: 2,
        ...
        questionsEn: [
          {
            ...
            hint: "Focus on the ComparisonError and what it reveals about access to the Git repository.",
            answer: 1,
          ...
          },
          {
            ...
            hint: "Think about what the retry setting in sync policy does when a sync fails.",
            answer: 1,
          ...
          },
          {
            ...
            hint: "Think about what a finalizer in ArgoCD ensures when an Application is deleted.",
            answer: 2,
          ...
          },
          {
            ...
            hint: "Focus on the Degraded health status and what it indicates about the running Pods.",
            answer: 0,
          ...
          },
          {
            ...
            hint: "Think about ApplicationSet and generating an Application per environment from a generator.",
            answer: 0,
          ...
          },
          {
            ...
            hint: "Notice the app is Synced but the Pod behaves unexpectedly - check the values.",
            answer: 0,
          ...
          },
          {
            ...
            hint: "Think about the sync-wave annotation that controls ordering between resources.",
            answer: 3,
          ...
          },
          {
            ...
            hint: "Notice the Application is Healthy but the Service returns 503 - check the selector.",
            answer: 2,
